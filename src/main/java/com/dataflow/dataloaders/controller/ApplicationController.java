...
public class ApplicationController {
    ...
    @PostMapping
    public ResponseEntity<Response> create(@RequestBody Application application, @RequestHeader HttpHeaders headers) {
    ...
    public ResponseEntity<Response> get(@Parameter(description = "Application ID") @PathVariable String applicationId,
    ...
    public ResponseEntity<Response> getAll(@RequestHeader HttpHeaders headers) {
        log.info(logPrefix, this.getClass().getSimpleName(), Thread.currentThread().getStackTrace()[1].getMethodName());
        Identifier identifier = Identifier.builder().headers(headers).build();
        return Response.getResponse(applicationService.getAllApplications(identifier));
    }
    ...
    public ResponseEntity<Response> update(@Parameter(description = "Application ID") @PathVariable String applicationId,
    ...
    public ResponseEntity<Response> delete(@Parameter(description = "Application ID") @PathVariable String applicationId,
                                           @RequestHeader HttpHeaders headers) {
        log.info(logPrefix, this.getClass().getSimpleName(), Thread.currentThread().getStackTrace()[1].getMethodName());
        Identifier identifier = Identifier.builder().headers(headers).word(applicationId).build();
